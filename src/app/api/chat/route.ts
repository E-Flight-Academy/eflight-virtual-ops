...
export async function POST(request: NextRequest) {
  try {
    ...
    instructionParts.push(
      ...
      "LINK CARDS: When your answer references a relevant page, include one or more [link: url | label] tags at the END of your response (before the [source: ...] tag). These render as clickable card buttons. For the label, use the actual page title as it appears in the Website Content, FAQ, or Products sections — do not shorten or paraphrase it. Use URLs from these sections provided in this prompt. Only include links that are directly relevant to the answer. Do not make up URLs.",
